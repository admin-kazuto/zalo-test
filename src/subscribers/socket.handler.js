...
//     // --- Dán vào bên trong io.on("connection", (socket) => { ... }) ---
...
//         return callback({
//           status: "error",
//           message: "Cần có tài khoản và User ID của người gửi lời mời.",
//         });
//       }

//       try {
//         socket.emit("scenario_update", {
//           message: `👍 Đang chấp nhận lời mời kết bạn từ User ID: ${userId}...`,
//         });
